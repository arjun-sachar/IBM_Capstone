    ...
    <a-row style="height:300px">
      <div class="tile tile__header tile__top">
        ...
        <div class="tile-content">
          <a-row style="height:calc(100% - 180px);overflow:auto">
              <ul class="rule-list">
                <li>Must be a CSV</li>
                <li>Must have 3 columns (Date, Genre, Page Views)</li>
              </ul>
          </a-row>
          <a-row
            ...
            <div style="width:calc(100% - 300px)">
              ...
              <div>
                <a-select v-model="cat1" style="width: 33%;padding-right:10px">
                  <a-select-option v-for="option in ['Data']" :value="option">{{
                    option
                  }}</a-select-option>
                </a-select>
                <a-select
                ...
                >
                  <a-select-option v-for="option in ['Genre']" :value="option">{{
                    option
                  }}</a-select-option>
                </a-select>
                <a-select
